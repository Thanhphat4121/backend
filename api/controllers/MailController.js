...
async function resetLink(email, id) {
  ...
  let transporter = nodemailer.createTransport({
    ...
    domain: "gmail.com",
    auth: {
      user: "19004057@st.vlute.edu.vn", // generated ethereal user
      pass: "364092431", // generated ethereal password
    },
  ...
  let mainOptions = await transporter.sendMail({
    from: '"Siuu Phone" <19004057@st.vlute.edu.vn>', // sender address
